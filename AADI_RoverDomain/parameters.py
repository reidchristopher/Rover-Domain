...
class Parameters:
    ...
    new_world_config = True # False -> Reuse existing world config, True -> Use new world config
    ...
    x_dim = 100  # X-Dimension of the rover map
    y_dim = 100  # Y-Dimension of the rover map
