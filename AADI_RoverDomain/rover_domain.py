...
class RoverDomain:
    ...
    @staticmethod
    def get_angle_dist(rovx, rovy, x, y):
        """
...
class MultiRewardRD(RoverDomain):
    def __init__(self, p):
        ...
        self.poi_types = p.poi_types
        if len(self.poi_types) != self.n_pois:
    ...
    def reset_to_init(self):
        super(MultiRewardRD, self).reset_to_init()
