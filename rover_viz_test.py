import rover_domain
from multi_poi_rover_domain import SequentialPOIRD
import numpy as np
import torch
import rendering
import time
...
# TODO do a test run to make sure this works with the multi-poi domain as-is
# TODO add different colors for the different POI types
# TODO import this render into my poi_tests and use it every 100 learning iterations to see how it updates.
#      Note: This will need to be imported into the step taking area, and have it pass in the updated positions and such
